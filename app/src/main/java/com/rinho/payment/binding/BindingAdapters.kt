package com.rinho.payment.binding
...
object BindingAdapters {
    ...
    fun TextView.setDateFormatted(time: String?, format: String) {
...
//        text = SimpleDateFormat(format).format(time)
        ...
        text=  text.substring(0, time.indexOf('T'))
...
//        val date = "2011-08-04"
        ...
        today = LocalDate.parse(text, formatter)

       text = today.format(arabicDateFormatter)
//        text=text.toString().replace("1", "يناير")
...
//        Log.d("changeTimeFormat", "changeTimeFormat: " +time1)
       ...
       var  time2=time1.replace('-','/')
        ...
        Log.d(TAG, "changeTimeFormat: "+text)
