...
class GetAllBudgets {
    ...
    fun login() {
        ...
        val userAuth = (service.getAllbudgets().getOrAwaitValue() as ApiSuccessResponse).body?.data?.budgets?.get(0)?.id
...
//                .addHeader("Accept-Language", Locale.getDefault().getLanguage())
    ...
    fun `fetch details and check response Code 200 returned`(){
        ...
        // Act
        val actualResponse = (service.getAllbudgets().getOrAwaitValue() as ApiSuccessResponse).body?.data?.budgets?.size!! >0
...
//        val  actualResponse = apiHelper.getEmployeeDetails().execute()
    ...
    fun `fetch details and check response success returned`(){
        ...
        // Act
//        val  actualResponse = apiHelper.getEmployeeDetails().execute()
        val actualResponse = (service.getAllbudgets().getOrAwaitValue() as ApiSuccessResponse ).body?.data
        // Assert
