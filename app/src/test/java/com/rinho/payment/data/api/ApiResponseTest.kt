...
import com.rinho.payment.data.api.ApiErrorResponse
import com.rinho.payment.data.api.ApiResponse
import com.rinho.payment.data.api.ApiSuccessResponse
import com.rinho.payment.models.GeneralResponse
import com.rinho.payment.models.IdentityGeneralResponse
...
class ApiResponseTest {
    ...
    fun successWithCode200AndBodyIdentifyGeneralResponse() {
        val apiResponse =
            ApiResponse.create(
                Response.success(IdentityGeneralResponse(
                    success = false,
                    errorMessage = "blah"
                ))
