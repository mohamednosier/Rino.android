...
import com.rinho.saudi2go.getOrAwaitValue
import com.rinho.payment.data.api.ApiService
import com.rinho.payment.data.api.ApiSuccessResponse
...
class GetAllAccounts {
    ...
    fun login() {
        ...
        val userAuth = (service.getAllaccounts().getOrAwaitValue() as ApiSuccessResponse).body?.data?.accounts?.get(0)?.balance
...
//                .addHeader("Accept-Language", Locale.getDefault().getLanguage())
                .addHeader("Authorization", "Bearer 368e0734f1b97d289c41dab0fc9067c7c7fb42ff4a9a33b97221177d6df87953")
                .build()
...
//
        val actualResponse = (service.getAllaccounts().getOrAwaitValue() as ApiSuccessResponse).body?.data?.accounts?.size!! >0
...
//        val  actualResponse = apiHelper.getEmployeeDetails().execute()
    ...
    fun `fetch details and check response success returned`(){
        ...
        // Act
//        val  actualResponse = apiHelper.getEmployeeDetails().execute()
        val actualResponse = (service.getAllaccounts().getOrAwaitValue() as ApiSuccessResponse).body?.data.toString()
        // Assert
...
//            )
            ...
            val reader = InputStreamReader(this.javaClass.classLoader?.getResourceAsStream("api-response/$path"))
